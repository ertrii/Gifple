...
namespace Gifple
{
    ...
    public class GifpleGenerate
    {
        ...
        public string Copyright { get; set; } = $"Generated by Gifple. © {DateTime.Today.ToString("yyyy")} <a href='https://github.com/ertrii/Gifple'>Gifple<a>.";
        ...
        {            
            ...
            Template.js += "document.getElementById('head-title').innerHTML=config.name,document.getElementById('proyect-name').innerHTML=config.name,document.getElementById('autor').innerHTML=config.autor,document.getElementById('description').innerHTML=config.description;const sequence=new Sequences('sequence',img);sequence.option.repeat=config.repeat,sequence.start();document.getElementById('copyright').innerHTML=config.copyright;";
    ...
    public class IMGFileGifple
    {
        ...
        public Bitmap Bmp {
            ...
            set {
                bmp = value;
                /*if (value.RawFormat == ImageFormat.Png)
                    bmp = value;
                else
